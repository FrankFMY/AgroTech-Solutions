        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M11.3 2.5c-.6-.4-1.4-.1-1.6.6C8.3 8 5 10.5 5 14c0 2.8 2.2 5 5 5s5-2.2 5-5c0-4.2-2.1-8-3.7-11.5zm7 0c-.6-.4-1.4-.1-1.6.6C15.3 8 12 10.5 12 14c0 2.8 2.2 5 5 5s5-2.2 5-5c0-4.2-2.1-8-3.7-11.5z" />
            </svg>
